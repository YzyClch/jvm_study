...
import com.yzy.study.data.HashMap.Node;
    ...
    implements Map<K,V>
{
     ...
     */
    static class Entry<K,V> extends com.yzy.study.data.HashMap.Node<K,V> {
        Entry<K,V> before, after;
        Entry(int hash, K key, V value, com.yzy.study.data.HashMap.Node<K,V> next) {
